  ...
  if (!opportunity) {
    return (
      <section className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        <Link
          href="/dashboard"
          className="inline-flex rounded-md border border-line bg-panel px-3 py-2 text-sm font-bold text-ink transition hover:border-pine"
        >
          Back to dashboard
        </Link>
        <div className="mt-6 rounded-lg border border-line bg-panel p-6 shadow-soft">
          <h1 className="text-3xl font-bold text-ink">Opportunity not found</h1>
        ...
        <div className="rounded-lg border border-line bg-panel p-6 shadow-soft">
          <div className="flex flex-col gap-5 border-b border-line pb-6 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <h1 className="mt-4 text-5xl font-bold text-ink">{opportunity.symbol}</h1>
              <p className="mt-2 text-base font-semibold text-ink/60">{opportunity.name}</p>
            </div>
            <div className="rounded-lg border border-line bg-surface p-4 text-center sm:min-w-36">
              <p className="text-xs font-bold uppercase tracking-normal text-ink/55">
                Opportunity
              </p>
              <p className="mt-2 text-4xl font-bold text-pine">
