        ...
        <tr>
          <td align="center" style="padding:28px 14px;">
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;border-collapse:collapse;font-family:Inter,Arial,sans-serif;color:#071418;">
              <tr>
                <td style="border-radius:22px 22px 0 0;background:linear-gradient(135deg,#061c1f,#0c4a4d 62%,#b7f34b);padding:28px;">
                    ...
                    <tr>
                      <td>
                        ...
                        <span style="display:inline-block;margin-left:12px;vertical-align:middle;">
                          ...
                          <span style="display:block;margin-top:6px;color:rgba(255,255,255,.74);font-size:13px;font-weight:700;">Daily swing trade intelligence</span>
                        </span>
                      </td>
                    </tr>
                  </table>
              ...
              <tr>
                <td style="border:1px solid #d8e0ea;border-top:0;border-radius:0 0 22px 22px;background:#ffffff;padding:28px;">
                  <div style="color:#52615b;font-size:15px;line-height:1.68;">
                    ${args.bodyHtml}
                  </div>
                  <div style="margin-top:26px;border-radius:16px;background:#f5f7fb;border:1px solid #d8e0ea;padding:16px;">
                    ...
                    <p style="margin:7px 0 0;color:#52615b;font-size:12px;line-height:1.6;">${safeFooter}</p>
                  </div>
                </td>
              </tr>
            </table>
...
export function buildBrandedMorningEmail(args: BrandedMorningEmailArgs) {
  ...
  const rows =
    top
          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:separate;border-spacing:0;margin:0 0 14px;border:1px solid #d8e0ea;border-radius:16px;background:#ffffff;">
            <tr>
              <td style="padding:16px;">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
                  <tr>
                    <td>
                      ...
                      <p style="margin:6px 0 0;color:#697770;font-size:12px;font-weight:800;text-transform:uppercase;">${escapeHtml(item.asset_type)}</p>
                    </td>
                    <td align="right">
                ...
                <p style="margin:14px 0 0;color:#52615b;font-size:13px;line-height:1.6;">Review the entry range before chasing price. Use the stop loss to decide if the setup fits your risk plan.</p>
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse;margin-top:14px;">
                  <tr>
                    <td style="width:50%;padding:0 6px 8px 0;">
                      <div style="border-radius:12px;background:#f5f7fb;border:1px solid #e6ece8;padding:12px;">
                        <p style="margin:0 0 5px;color:#697770;font-size:10px;font-weight:900;text-transform:uppercase;">Confidence</p>
                        <p style="margin:0;color:#071418;font-size:16px;font-weight:900;">${item.confidence}/100</p>
                      </div>
                    </td>
                    <td style="width:50%;padding:0 0 8px 6px;">
                      <div style="border-radius:12px;background:#f5f7fb;border:1px solid #e6ece8;padding:12px;">
                        <p style="margin:0 0 5px;color:#697770;font-size:10px;font-weight:900;text-transform:uppercase;">Risk</p>
                  ...
                  <tr>
                    <td style="width:50%;padding:0 6px 8px 0;">
                      <div style="border-radius:12px;background:#f5f7fb;border:1px solid #e6ece8;padding:12px;">
                        <p style="margin:0 0 5px;color:#697770;font-size:10px;font-weight:900;text-transform:uppercase;">Entry</p>
                        <p style="margin:0;color:#071418;font-size:15px;font-weight:900;">${currency(item.entry_low)} - ${currency(item.entry_high)}</p>
                      </div>
                    </td>
                    <td style="width:50%;padding:0 0 8px 6px;">
                      <div style="border-radius:12px;background:#f5f7fb;border:1px solid #e6ece8;padding:12px;">
                        <p style="margin:0 0 5px;color:#697770;font-size:10px;font-weight:900;text-transform:uppercase;">Target</p>
                  ...
                  <tr>
                    <td style="width:50%;padding:0 6px 0 0;">
                      <div style="border-radius:12px;background:#fff7f5;border:1px solid #f0d5ce;padding:12px;">
                        <p style="margin:0 0 5px;color:#697770;font-size:10px;font-weight:900;text-transform:uppercase;">Stop loss</p>
      ...
      .join("") ||
    `
      <div style="border:1px solid #d8e0ea;border-radius:16px;background:#ffffff;padding:18px;color:#697770;font-size:14px;font-weight:700;">
