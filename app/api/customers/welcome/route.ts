...
export async function POST(request: NextRequest) {
  ...
  const html = buildBrandedEmail({
    ...
    bodyHtml: `
      ...
      <p style="margin:0;color:#52615b;">Your 30-day free trial has started. Use SwingFi to review ranked swing-trade opportunities, confidence, risk, entry range, target, stop loss, and estimated trade time frame.</p>
      ...
      <div style="margin-top:22px;border-radius:16px;background:#f4f8f5;border:1px solid #d8e0ea;padding:16px;">
        ...
        <p style="margin:7px 0 0;color:#52615b;font-size:13px;line-height:1.6;">Start with the highest-ranked setups, then compare confidence, risk, entry range, target, stop loss, and the estimated holding window before doing deeper research.</p>
      </div>`,
  });
